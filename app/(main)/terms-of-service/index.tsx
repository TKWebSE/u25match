      ...
      >
        <View style={{ maxWidth: 800, alignSelf: 'center', width: '100%' }}>
          ...
          <View style={{ backgroundColor: 'white', padding: 20, borderRadius: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2, elevation: 2 }}>
            ...
            <Text style={{ fontSize: 16, lineHeight: 24, color: '#333', marginBottom: 20 }}>
              本利用規約（以下「本規約」といいます。）は、u25match（以下「当社」といいます。）が提供するサービス（以下「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
            </Text>
            ...
            <Text style={{ fontSize: 16, lineHeight: 24, color: '#333', marginBottom: 20 }}>
              ...
              {'\n'}・当社、本サービスの他のユーザーまたはその他の第三者のサーバーまたはネットワークの機能を破壊したり、妨害したりする行為
              {'\n'}・その他、当社が不適切と判断する行為
            </Text>
            ...
            <Text style={{ fontSize: 16, lineHeight: 24, color: '#333', marginBottom: 20 }}>
              ...
              {'\n'}・本規約の変更が本サービス利用契約の目的に反せず、かつ、変更の必要性、変更後の規約の内容の相当性その他の変更に係る事情に照らして合理的なものであるとき。
            ...
            <Text style={{ fontSize: 16, lineHeight: 24, color: '#333', marginTop: 30, textAlign: 'center' }}>
              以上
            </Text>
          </View>
        </View>
