 ...
 * 都道府県コードから都道府県名を取得
 */
export const getPrefectureName = (code: PrefectureCode): PrefectureName | undefined => {
 ...
 * 都道府県名から都道府県コードを取得
 */
export const getPrefectureCode = (name: PrefectureName): PrefectureCode | undefined => {
