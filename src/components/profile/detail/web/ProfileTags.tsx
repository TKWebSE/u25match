 ...
 * @param tags - タグ配列
 */
export const WebProfileTags: React.FC<ProfileTagsProps> = ({ tags }) => {
  if (!tags || tags.length === 0) {
    return null;
  }

  return (
    <View style={ProfileDetailStyles.section}>
      <Text style={ProfileDetailStyles.sectionTitle}>興味・趣味</Text>
